...
4. Upload a single `.py` file to Gradescope. This file should contain:
   - The function `llm_parse_for_wttr()` to process the raw text. Make sure you include type hints for the params and return!
   - A very nice system prompt inside of that function.
   - A dictionary of test cases and the function to evaluate them...
...
You will want to save this script to a GitHub repository.
