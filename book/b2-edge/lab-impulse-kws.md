...
Read Iodice's [*TinyML Cookbook, 2nd Ed*, Chapter 4: "Using Edge Impulse and the Arduino Nano to Control LEDs with Voice Commands"](https://learning.oreilly.com/library/view/tinyml-cookbook/9781837637362/Text/Chapter_04.xhtml)

### Design

The design portion will be submitted to Gradescope.
...
We will add edge-impulse-cli and arduino-cli to your Pi.
...
You don't need to do the "setting keys" part.
